...
if (file_exists('/var/www/site-php')) {
  require('/var/www/site-php/toweringoaks/toweringoaks-settings.inc');
}
...
if (isset($_ENV['AH_SITE_ENVIRONMENT'])) {
  ...
  $conf['file_private_path'] = '/Users/joshua.taylor/Sites/devdesktop/private/toweringoaks';
}
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_toweringoaks_dev_default.inc'))
  require($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_toweringoaks_dev_default.inc');
//</DDSETTINGS>
